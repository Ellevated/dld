...
| TECH-181 | Hermes intake bridge — orchestrator scan_inbox диспатчит только Status: queued (clean break от legacy new) | queued | P1 | [spec](features/TECH-181-2026-05-07-hermes-intake-bridge-status-gate.md) |

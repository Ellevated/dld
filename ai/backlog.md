...
| TECH-172 | Single Status write path — callback единственный writer, autopilot не трогает | blocked | P1 | [spec](features/TECH-172-2026-05-02-single-status-write-path.md) |

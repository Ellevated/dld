...
| TECH-177 | Callback: tighten `_spec_has_merged_implementation` matcher — subject-only ID match (cross-spec body mention false-positive) | queued | P1 | [spec](features/TECH-177-2026-05-04-callback-cross-spec-id-mention.md) |

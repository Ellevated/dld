...
| TECH-183 | Spark Verified References — grep-evidence gate для concrete refs (paths/endpoints/schema/state-keys) в спеках; codebase.md `## Verified References` + feature-mode.md Gate 8 | queued | P1 | [spec](features/TECH-183-2026-05-14-spark-verified-references.md) |

...
| 2026-09-24 | TECH-225 | success | Task 1/6: runner_ratelimit (from_message/summary/decide_exit), EC-1..EC-5 + реальные типы SDK 0.1.63 | 0 | 2 | pending |
| 2026-09-24 | TECH-225 | success | Task 2/6: consume собирает rate_limit_events, claude-runner exit 5 до salvage, _EXIT_REASONS[5] (EC-6/EC-7) | 0 | 4 | pending |
| 2026-09-24 | TECH-225 | success | Task 3/6: db_decisions.count_requeues_since (project_id+spec_id+reason, EC-10) | 0 | 4 | pending |
| 2026-09-24 | TECH-225 | success | Task 4/6: callback_ratelimit.requeue — exit 5 → queued, 3/24ч → blocked repeated_rate_limit (EC-8/9/11) | 0 | 4 | pending |
| 2026-09-24 | TECH-225 | success | Task 5/6: EXP-014 | 0 | 1 | pending |
| 2026-09-24 | TECH-225 | success | Task 6/6: status-model + dependencies (+ documenter: components, README, model-capabilities) | 0 | 2 | pending |
| 2026-09-24 | TECH-225 | advisory | Tasks 1,4 advisory → 2026-09-24-TECH-225-advisory.md | 0 | 0 | pending |

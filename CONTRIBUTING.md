...
2. Use the [bug report template](https://github.com/Ellevated/dld/issues/new?template=bug_report.md)
...
2. Use the [feature request template](https://github.com/Ellevated/dld/issues/new?template=feature_request.md)

...
When AI agents maintain the codebase, cost/effort assessments MUST reflect compute reality. For human teams, use both compute-cost and traditional estimates.

### Cost Reference

| Change Size | Time | Cost | Human Team | Example |
|-------------|------|------|------------|---------|
| Simple (1-3 files) | 15 min | ~$1 | 1-2 hours | Fix typo, add field, update config |
| Medium (5-10 files) | 1-2 hours | ~$5 | 1-2 days | New endpoint, refactor module |
| Large (20+ files) | 3-4 hours | ~$15 | 1-2 weeks | Cross-domain change, new feature |
| Domain extraction | 1 day | ~$50 | 1-2 sprints | Split monolith, new bounded context |
...
(This applies regardless of whether agents or humans implement.)
